...
let githubLink = "https://github.com/stijnmoreels/FSec/stijnmoreels/FSec"

// Specify more information about your project
let info =
  [ "project-name", "FSec"
    "project-author", "Stijn Moreels"
    "project-summary", "FSec is a tool for automatically running security tests for .NET programs"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/FSec" ]
